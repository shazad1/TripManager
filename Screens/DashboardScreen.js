          ...
          <ScrollView>
            ...
            <View style={styles.introCard}>
              ...
              <View style={styles.secondLine}>
                ...
                <View style={styles.inforLet}>
                  ...
                  <Text style={styles.para}>Network Status</Text>
                </View>
              </View>
              <View style={styles.secondLine}>
                <View style={styles.inforLet}>
                  <View style={styles.heading}>
                    <Text style={styles.heading}>
                      {location?.street} {location?.city} {location?.subRegion}{" "}
                      {location?.region} {location?.postCode}
                    </Text>
                  </View>
                  <Text style={styles.para}>Current Location</Text>
                  ...
                  >
                    <Text style={styles.tripButtonText}>Log out</Text>
                  </TouchableOpacity>
                </View>
              </View>
            </View>
              ...
              <View style={styles.trips}>
                {newTrips?.map((trip) => {
                  return (
                    ...
                    >
                      <Text style={styles.tripButtonText}>{trip.name}</Text>
                    </TouchableOpacity>
                  );
                })}
              </View>
            ...
            {role == "owner" ? (
              <View style={styles.introCard}>
                ...
                <Text style={styles.heading}>
                  Click the driver to veiw his trips
                </Text>
                <View style={styles.drivers}>
                  {myDrivers.map((driver) => {
                    return (
                      <TouchableOpacity
                        style={
                          driver.pin == selectedMyDriver?.pin
                            ...
                            return (
                              <TouchableOpacity
                                ...
                                onPress={async () => {
                                  ...
                                  setProgress(false);
                                  ToastAndroid.show(
                                    "Email sent to  " + state.loggedInEmail,
                                    ToastAndroid.LONG
                                  );
                                }}
                              >
                          ...
                          <View style={styles.driverTripLine1}>
                            ...
                            <TouchableOpacity
                              ...
                              onPress={async () => {
                                setProgress(true);
                                await fetch(
                                  "https://asia-southeast2-tawtripmanager.cloudfunctions.net/createTripInvoice?pin=" +
                                    selectedMyDriver?.pin +
                                    "&&business=1&&tripName=" +
                                    trip.name +
                                    "&&name=" +
