    ...
    firebase.database
      ...
      .push({
        ...
        location:
          ...
          locatObject.region +
          " " +
          locatObject.subRegion +
          " " +
          locatObject.street +
          " " +
          locatObject.postCode,
    ...
    <Provider store={Store}>
      <NavigationContainer>
        ...
        >
          ...
          />
          <Stack.Screen name="WhichTruck" component={WhichTruckScreen} />
          <Stack.Screen
            name="NumberOfThings"
            component={NumberOfThingsScreen}
          />

          <Stack.Screen name="ThingsToCarry" component={ThingsToCarrySCreen} />
          ...
          />
          <Stack.Screen name="TripEditor" component={TripEditor} />
          <Stack.Screen
